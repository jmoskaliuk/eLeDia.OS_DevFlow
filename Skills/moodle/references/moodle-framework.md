...
Die kanonische Auswahl der Referenzen steht in `../SKILL.md`. Lade für die
aktuelle Aufgabe nur die dort genannten Dateien. Diese Framework-Referenz
enthält den konsolidierten historischen Wissensstand und erweitert nicht die
Berechtigung zum Committen, Pushen, Deployen oder Veröffentlichen.
...
**API-Regeln** (detailliert in `references/moodle-design-system.md`):
...
> Tiefere Details zum Design System: `references/moodle-design-system.md` (Token-Katalog,
